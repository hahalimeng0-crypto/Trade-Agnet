...
def load_business_config() -> BusinessConfig:
    ...
    backend = os.environ.get(
        "BUSINESS_DATABASE_BACKEND", "mysql" if profile == "production" else cfg.database_backend
    ).strip().lower()
    ...
    cfg.mysql_host = os.environ.get(
        "TRADE_OPS_MYSQL_HOST", os.environ.get("NANOCLAW_MYSQL_HOST", cfg.mysql_host))
    cfg.mysql_port = int(os.environ.get(
        "TRADE_OPS_MYSQL_PORT", os.environ.get("NANOCLAW_MYSQL_PORT", cfg.mysql_port)))
    cfg.mysql_database = os.environ.get(
        "TRADE_OPS_MYSQL_DATABASE", os.environ.get("NANOCLAW_MYSQL_DATABASE", cfg.mysql_database))
    cfg.mysql_user = os.environ.get(
        "TRADE_OPS_MYSQL_USER", os.environ.get("NANOCLAW_MYSQL_USER", cfg.mysql_user))
    cfg.mysql_password = os.environ.get(
        "TRADE_OPS_MYSQL_PASSWORD", os.environ.get("NANOCLAW_MYSQL_PASSWORD", cfg.mysql_password))
