...
def parse_email(raw: bytes, *, account_id: str, provider: str, folder: str,
    ...
    return EmailEnvelope(
        ...
        auto_submitted=_header(message.get("Auto-Submitted")).strip(),
        precedence=_header(message.get("Precedence")).strip(),
        sent_at=_date(message.get("date")), received_at=received_at,
